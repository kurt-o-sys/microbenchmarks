...
public final class ObjectCreationBenchmarks_longWithConstructor {
    ...
    public Collection<? extends Result> longWithConstructor_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_objectcreationbenchmarks0_0.longWithConstructor());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            longWithConstructor_thrpt_jmhLoop(control, res, l_objectcreationbenchmarks0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "longWithConstructor", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void longWithConstructor_thrpt_jmhLoop(InfraControl control, RawResults result, ObjectCreationBenchmarks_1_jmh l_objectcreationbenchmarks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> longWithConstructor_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            ObjectCreationBenchmarks_1_jmh l_objectcreationbenchmarks0_0 = _jmh_tryInit_f_objectcreationbenchmarks0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            longWithConstructor_avgt_jmhLoop(control, res, l_objectcreationbenchmarks0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_objectcreationbenchmarks0_0.longWithConstructor());
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "longWithConstructor", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void longWithConstructor_avgt_jmhLoop(InfraControl control, RawResults result, ObjectCreationBenchmarks_1_jmh l_objectcreationbenchmarks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> longWithConstructor_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            ObjectCreationBenchmarks_1_jmh l_objectcreationbenchmarks0_0 = _jmh_tryInit_f_objectcreationbenchmarks0_0(control, threadParams);
            ...
            longWithConstructor_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), l_objectcreationbenchmarks0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_objectcreationbenchmarks0_0.longWithConstructor());
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "longWithConstructor", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void longWithConstructor_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, ObjectCreationBenchmarks_1_jmh l_objectcreationbenchmarks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> longWithConstructor_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            ObjectCreationBenchmarks_1_jmh l_objectcreationbenchmarks0_0 = _jmh_tryInit_f_objectcreationbenchmarks0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            longWithConstructor_ss_jmhStub(control, res, l_objectcreationbenchmarks0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "longWithConstructor", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void longWithConstructor_ss_jmhStub(InfraControl control, RawResults result, ObjectCreationBenchmarks_1_jmh l_objectcreationbenchmarks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
