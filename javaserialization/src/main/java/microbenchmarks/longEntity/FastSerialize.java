      ...
      extends BenchmarkSerialize
{
   ...
   private microbenchmarks.longEntity.model.FactoidFST factoid
         = new microbenchmarks.longEntity.model.FactoidFST(entity, attribute, value);
   ...
   public void prepare() {
      fstConf.registerClass(microbenchmarks.longEntity.model.FactoidFST.class, Instant.class);
   }
   ...
   public byte[] benchmarkSerialize() {
      ...
      try
      {
         fstOut.writeObject(factoid, microbenchmarks.longEntity.model.FactoidFST.class);
         fstOut.flush();
